...
contract TEST {
  ...
  function crytic_find() public view returns (bool) {
    if (!everSet) {
      return true;
    }
    uint256 i;
  ...
  function crytic_append() public view returns (bool) {
    if (!everSet) {
      return true;
    }    
  ...
  function crytic_extend() public view returns (bool) {
    if (!everSet) {
      return true;
    }    
  ...
  function crytic_sExtend() public returns (bool) {
    if (!everSet) {
      return true;
    }
  ...
  function crytic_isEqual() public view returns (bool) {
    if (!everSet) {
      return true;
    }    
  ...
  function crytic_sReverse() public returns (bool) {
    if (!everSet) {
      return true;
    }    
  ...
  function crytic_diff() public view returns (bool) {
    if (!everSet) {
      return true;
    }
  ...
  function crytic_union() public view returns (bool) {
    if (!everSet) {
      return true;
    }
    address [] memory empty = new address[](0);
  ...
  function crytic_intersect() public view returns (bool) {
    if (!everSet) {
      return true;
    }
    address [] memory empty = new address[](0);
  ...
  function crytic_pop() public view returns (bool) {
    if (!everSet) {
      return true;
    }    
    if (!AddressArrayUtils.contains(addrs1, a)) {
  ...
  function crytic_sRemoveCheap() public returns (bool) {
    if (!everSet) {
      return true;
    }    
    if (!AddressArrayUtils.contains(addrs1, a)) {
  ...
  function crytic_revert_sRemoveCheap() public returns (bool) {
    if (!everSet) {
      revert();
    }
    if (AddressArrayUtils.contains(addrs1, a)) {
  ...
  function crytic_sPop() public returns (bool) {
    if (!everSet) {
      return true;
    }    
    if (!AddressArrayUtils.contains(addrs1, a)) {
  ...
  function crytic_revert_sPop() public returns (bool) {
    if (!everSet) {
      revert();
    }
  ...
  function crytic_sPopCheap() public returns (bool) {
    if (!everSet) {
      return true;
    }    
    if (!AddressArrayUtils.contains(addrs1, a)) {
  ...
  function crytic_revert_sPopCheap() public returns (bool) {
    if (!everSet) {
      revert();
    }
    uint256 index = addrs1.length;
  ...
  function crytic_argGet() public view returns (bool) {
    if (!everSet) {
      return true;
    }
    if (addrs1.length < 1) {
